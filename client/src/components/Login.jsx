        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <div>
              ...
              />
              <label htmlFor="editor" className="ml-2 mr-4">Editor</label>
              <input
                type="radio"
                id="channel"
                name="type"
                ...
                onChange={handleTypeChange}
              />
              <label htmlFor="channel" className="ml-2">Channel</label>
            </div>
          </div>
          <div className="mb-4">
            <label htmlFor="email" className="block text-gray-700">Email</label>
            <input type="email" id="email" className="form-input mt-1 block w-full" onChange={handleChange} />
          </div>
          <div className="mb-4">
            <label htmlFor="password" className="block text-gray-700">Password</label>
            <input type="password" id="password" className="form-input mt-1 block w-full" onChange={handleChange} />
          </div>
          {!login && formData.type === "channel" && (
            <>
              <div className="mb-4">
                <label htmlFor="channelUserName" className="block text-gray-700">Channel UserName</label>
                <input type="text" id="channelUserName" className="form-input mt-1 block w-full" onChange={handleChange} />
              </div>
              <div className="mb-4">
                <label htmlFor="channelPasswd" className="block text-gray-700">Channel Password</label>
                <input type="password" id="channelPasswd" className="form-input mt-1 block w-full" onChange={handleChange} />
              </div>
            </>
          )}
          {!login && (
            <>
              <div className="mb-4">
                ...
                <input type="text" id="name" className="form-input mt-1 block w-full" onChange={handleChange} />
              </div>
              <div className="mb-4">
          ...
          <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">{login ? "Login" : "Sign Up"}</button>
        </form>
        <p className="mt-4 text-center text-gray-700 cursor-pointer" onClick={toggleForm}>
